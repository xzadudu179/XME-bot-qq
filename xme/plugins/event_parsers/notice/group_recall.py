...
#         debug_msg("无法获取撤回信息")
#         return
#     # debug_msg(session.event.group_id, session.event.user_id)
...
#         # debug_msg(c.gradient_text("#dda3f8","#66afff" ,text=user_qq_data))
...
#         # debug_msg(c.gradient_text("#dda3f8","#66afff" ,text=sender_qq_data))
...
#     # debug_msg(c.gradient_text("#dda3f8","#66afff" ,text=f"{recall_info}\n{recall_detail}"))
